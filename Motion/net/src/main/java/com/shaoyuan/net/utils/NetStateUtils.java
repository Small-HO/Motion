package com.shaoyuan.net.utils;
...
/**
 * Created by small-ho on 2019/7/4 13:19
 * title：网络状态获取工具
 */
public class NetStateUtils {
    ...
    public static boolean isMobileConnected(Context context) {
        if (context != null) {
            ...
            if (networkInfo != null && networkInfo.getType() == ConnectivityManager.TYPE_MOBILE) return networkInfo.isAvailable();
        }
        return false;
    }
