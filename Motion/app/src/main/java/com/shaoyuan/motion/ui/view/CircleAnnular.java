 ...
 *描述：  
 ****/
public class CircleAnnular extends View {

    /**
     * 默认颜色
     */
    private static final int[] DEFAULT_COLOR = new int[]{0xff82B8FF, 0xffFF7F78, 0xffFFAE72, 0xff74D1B1, 0xff82B8FF};
    /**
     * 圆环半径，以内环算
     */
    ...
    public CircleAnnular(Context context) {
        this(context, null);
    }

    public CircleAnnular(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircleAnnular(Context context, AttributeSet attrs, int defStyleAttr) {
